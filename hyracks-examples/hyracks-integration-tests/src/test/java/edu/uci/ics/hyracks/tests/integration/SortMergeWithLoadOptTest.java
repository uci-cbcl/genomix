...
import edu.uci.ics.hyracks.dataflow.std.sort.ExternalSortWithLoadOptOperatorDescriptor;
import edu.uci.ics.hyracks.dataflow.std.sort.InMemorySortOperatorDescriptor;

public class SortMergeWithLoadOptTest extends AbstractIntegrationTest {
    @Test
    ...
    public void sortMergeTest02() throws Exception {
        ...
        ExternalSortWithLoadOptOperatorDescriptor sorter = new ExternalSortWithLoadOptOperatorDescriptor(spec, 4,
                new int[] { 1, 0 }, new IBinaryComparatorFactory[] {
                        PointableBinaryComparatorFactory.of(UTF8StringPointable.FACTORY),
                        PointableBinaryComparatorFactory.of(UTF8StringPointable.FACTORY) }, ordersDesc, true);
        PartitionConstraintHelper.addAbsoluteLocationConstraint(spec, sorter, NC1_ID, NC2_ID);
