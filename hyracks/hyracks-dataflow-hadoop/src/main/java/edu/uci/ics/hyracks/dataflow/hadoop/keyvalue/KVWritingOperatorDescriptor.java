...
public class KVWritingOperatorDescriptor extends AbstractSingleActivityOperatorDescriptor{
	...
	public KVWritingOperatorDescriptor(IOperatorDescriptorRegistry spec,
