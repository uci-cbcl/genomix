...
public class UTF8StringBinaryHashFunctionFamilyUsingCityHash implements IBinaryHashFunctionFamily {

    private static final long serialVersionUID = 1L;

    public static final IBinaryHashFunctionFamily INSTANCE = new UTF8StringBinaryHashFunctionFamilyUsingCityHash();

    private UTF8StringBinaryHashFunctionFamilyUsingCityHash() {
    ...
    public static long[] cityHash128(byte[] s, int pos, int len) {
        ...
        if (len >= 16) {
            ...
            return cityHash128WithSeed(new byte[0], 0, 0, fetch64(s, pos + 0) ^ (len * k0), fetch64(s, pos + len - 8)
                    ^ k1);
        } else {
    ...
    public IBinaryHashFunction createBinaryHashFunction(final int seed) {
        return new IBinaryHashFunction() {
            ...
            public int hash(byte[] bytes, int offset, int length) {
                return (int) cityHash64WithSeed(bytes, offset, length, seed);
            }
        };
    }
