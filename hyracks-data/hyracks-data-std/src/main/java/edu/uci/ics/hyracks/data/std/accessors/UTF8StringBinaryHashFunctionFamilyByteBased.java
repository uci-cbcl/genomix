...
public class UTF8StringBinaryHashFunctionFamilyByteBased implements IBinaryHashFunctionFamily {
    public static final IBinaryHashFunctionFamily INSTANCE = new UTF8StringBinaryHashFunctionFamilyByteBased();
    ...
    private UTF8StringBinaryHashFunctionFamilyByteBased() {
    }
