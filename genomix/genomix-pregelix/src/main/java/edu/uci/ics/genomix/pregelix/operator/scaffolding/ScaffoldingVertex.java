...
public class ScaffoldingVertex extends BFSTraverseVertex {
    ...
    public void addReadsToScaffoldingMap(ReadHeadSet readIds, READHEAD_ORIENTATION readHeadType) {
    ...
    public void generateScaffoldingMap() {
        ...
        if (vertex.isValidReadHead(SCAFFOLDING_VERTEX_MIN_COVERAGE, SCAFFOLDING_VERTEX_MIN_LENGTH)) {
            addReadsToScaffoldingMap(vertex.getStartReads(), READHEAD_ORIENTATION.UNFLIPPED);
            addReadsToScaffoldingMap(vertex.getEndReads(), READHEAD_ORIENTATION.FLIPPED);
