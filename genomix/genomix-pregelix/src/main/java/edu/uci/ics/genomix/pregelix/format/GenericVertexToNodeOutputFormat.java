...
public abstract class GenericVertexToNodeOutputFormat<V extends Node> extends
	...
	@Override
	public VertexWriter<VKmer, V, NullWritable> createVertexWriter(
			TaskAttemptContext context) throws IOException,
			InterruptedException {
		@SuppressWarnings("unchecked")
		RecordWriter<VKmer, Node> recordWriter = binaryOutputFormat
	...
	public static class BinaryLoadGraphVertexWriter<V extends Node> extends
		...
		public BinaryLoadGraphVertexWriter(
				RecordWriter<VKmer, Node> lineRecordWriter) {
			super(lineRecordWriter);
		}

		@Override
		public void writeVertex(Vertex<VKmer, V, NullWritable, ?> vertex)
				throws IOException, InterruptedException {
			getRecordWriter().write(vertex.getVertexId(),
					vertex.getVertexValue().getCopyAsNode());
		}
	}
}
