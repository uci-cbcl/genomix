...
public class InitialGraphCleanInputFormat extends
        InitialGraphCleanVertexInputFormat<VKmer, VertexValueWritable, NullWritable, MessageWritable> {
    /**
     * Format INPUT
     */
...
class BinaryLoadGraphReader extends BinaryVertexReader<VKmer, VertexValueWritable, NullWritable, MessageWritable> {
    ...
    public BinaryLoadGraphReader(RecordReader<VKmer, Node> recordReader) {
        super(recordReader);
    }
