...
public class P2PathMergeOutputFormat extends GraphCleanVertexOutputFormat<VKmer, P2VertexValue, NullWritable> {

    @Override
    public VertexWriter<VKmer, P2VertexValue, NullWritable> createVertexWriter(TaskAttemptContext context)
     ...
     */
    public static class BinaryLoadGraphVertexWriter extends BinaryVertexWriter<VKmer, P2VertexValue, NullWritable> {
        public BinaryLoadGraphVertexWriter(RecordWriter<VKmer, VertexValueWritable> lineRecordWriter) {
            super(lineRecordWriter);
        }

        @Override
        public void writeVertex(Vertex<VKmer, P2VertexValue, NullWritable, ?> vertex) throws IOException,
