...
public class KmerFactoryRandomTest {
    ...
    public void TestGetKmerByReadReverse() {
        ...
        String expectedReverse = RandomTestHelper.getFlippedGeneStr(input.substring(0, kmerSize));
    ...
    public void TestMergeTwoKmer() {
        ...
        String input1 = RandomTestHelper.generateGeneString(strLength1);
        ...
        String input2 = RandomTestHelper.generateGeneString(strLength2);
