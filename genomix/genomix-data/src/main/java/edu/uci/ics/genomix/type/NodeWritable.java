...
//    public int stepCount;
    ...
    public enum EDGETYPE {
         ...
         */
        public static EDGETYPE mirrorEdge(EDGETYPE edgeType){
            switch (edgeType) {
                case FF:
                    return RR;
                case FR:
        ...
        public EDGETYPE mirrorEdge(){
            return mirrorEdge(this);
        }
...
//        public static final byte DIR_FR = 0b00 << 0;
