...
public class NodeWritable implements WritableComparable<NodeWritable>, Serializable {
    ...
    public NodeWritable(VKmerListWritable[] edges, PositionListWritable[] threads, PositionListWritable startReads,
            PositionListWritable endReads, VKmerBytesWritable kmer, float coverage) {
        this();
    ...
    public void set(VKmerListWritable[] edges, PositionListWritable[] threads, PositionListWritable startReads,
            PositionListWritable endReads, VKmerBytesWritable kmer2, float coverage) {
        for (byte d : DirectionFlag.values) {
    ...
    public void mergeCoverage(NodeWritable other) {
        ...
        float adjustedLength = kmer.getKmerLetterLength() + other.kmer.getKmerLetterLength()
        ...
        float otherCount = (other.kmer.getKmerLetterLength() - KmerBytesWritable.getKmerLength() - 1)
