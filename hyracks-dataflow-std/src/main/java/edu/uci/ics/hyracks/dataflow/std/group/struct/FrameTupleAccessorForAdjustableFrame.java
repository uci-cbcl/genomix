...
public class FrameTupleAccessorForAdjustableFrame implements IFrameTupleAccessor {
    private int frameSize;
    private final RecordDescriptor recordDescriptor;

    private ByteBuffer buffer;

    public FrameTupleAccessorForAdjustableFrame(RecordDescriptor recordDescriptor) {
        this.recordDescriptor = recordDescriptor;
    }

    public void resetFrameSize(int newFrameSize) {
    ...
    public void reset(ByteBuffer buffer) {
        this.buffer = buffer;
        this.frameSize = buffer.capacity();
    }
