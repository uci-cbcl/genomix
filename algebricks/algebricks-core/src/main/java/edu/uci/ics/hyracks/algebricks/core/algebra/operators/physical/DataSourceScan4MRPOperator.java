...
public class DataSourceScan4MRPOperator extends AbstractScanPOperator {

    private IDataSource<?> dataSource;

    public DataSourceScan4MRPOperator(IDataSource<?> dataSource) {
        this.dataSource = dataSource;
    }

    @Override
    public PhysicalOperatorTag getOperatorTag() {
        return PhysicalOperatorTag.DATASOURCESCAN4MR;
    }
